...
*****************************************
 ...
 to interface this display. This module also
 uses the KY040 Rotary Encoder for input. 
...
class Display:
	...
	def _init_input(self):
		...
		self.debounce_ms = 750  # number of milliseconds to debounce input
		self.input_event = None
		self.input_counter = 0
		self.last_event = [time.time(), None]
