...
class Display(DisplayBase):
	...
	def _init_display_device(self):
		...
		self.serial = spi(port=0, device=0, gpio_DC=dc_pin, gpio_RST=rst_pin, bus_speed_hz=6000000,
					reset_hold_time=0.2, reset_release_time=0.2)
		self.device = st7789(self.serial, active_low=False, width=240, height=240, gpio_LIGHT=led_pin, rotate=self.rotation)
